...
import updateStudentDataAction from "@/server/updateStudentDataAction";
...
const UpdateStudentForm = ({
	stuInfo: { id, firstName, lastName, email, gender, teacherId },
	tData,
	...
	const updateStudentFormSubmitHandle = async ({
		firstName,
		lastName,
		email,
		gender,
	...
	return (
		<>
			<form
				onSubmit={handleSubmit(updateStudentFormSubmitHandle)}
